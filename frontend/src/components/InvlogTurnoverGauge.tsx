...
import type { InvlogTurnoverData } from "@/lib/api";

interface InvlogTurnoverGaugeProps {
  data: InvlogTurnoverData;
}

export function InvlogTurnoverGauge({ data }: InvlogTurnoverGaugeProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-green-50 rounded-lg p-3">
          <p className="text-xs text-green-600 font-medium">Days in Period</p>
